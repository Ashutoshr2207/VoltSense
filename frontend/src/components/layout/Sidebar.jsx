...
export default function Sidebar({ mobileOpen, setMobileOpen }) {
  ...
  const navItems = [
    ...
    { id: 'analysis', label: 'Battery Analysis', icon: 'monitor_heart' },
    { id: 'charging', label: 'Charging Map', icon: 'ev_station' },
    { id: 'predictions', label: 'Performance History', icon: 'query_stats' },
  ];
